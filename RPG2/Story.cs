...
namespace RPG2
{
    ...
    class Start
    {
        public static (string, string) StartText()
        {
            ...
            string[] _nameresponse = { protagonist.NarrationName + ": Such a stupid fucking name. " + protagonist.Name + ".", "I pity the Gods, naming us animals. Breathing life into us with an assignment, like we even matter. Like lambs to the slaughter in this life. Probably in the next too." };
